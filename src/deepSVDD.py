...
class DeepSVDD(object):
    ...
    def __init__(self, objective: str = 'one-class', nu: float = 0.1, focal_parameter: float = 0.1, update_center_epochs: int = 100):
    ...
    def train(self, dataset: BaseADDataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 50,
        ...
        self.trainer = DeepSVDDTrainer(self.objective, self.R, self.c, self.nu, self.focal_parameter, self.update_center_epochs, optimizer_name, lr=lr,
